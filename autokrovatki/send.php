...
function emailFormSubmission()
{
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Форма:</b></td><td>' . htmlentities($_REQUEST["ordername"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Серия:</b></td><td>' . htmlentities($_REQUEST["series"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Модель:</b></td><td>' . htmlentities($_REQUEST["model"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Цена:</b></td><td>' . htmlentities($_REQUEST["price"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Цвет:</b></td><td>' . htmlentities($_REQUEST["color"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Доп. опции:</b></td><td>' . htmlentities($_REQUEST["add"],ENT_COMPAT,'UTF-8') . '</td></tr>';
